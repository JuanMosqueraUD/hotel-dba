...
public class EmpleadoController {
    ...
    @PutMapping("/{cedula}")
    public ResponseEntity<Empleado> actualizarEmpleado(@PathVariable("cedula") String cedula, @RequestBody Empleado empleado) {
        Empleado actualizado = empleadoRepository.update(cedula, empleado);
    ...
    public ResponseEntity<Void> eliminarEmpleado(@PathVariable("cedula") String cedula) {
        boolean eliminado = empleadoRepository.deleteByCedula(cedula);
